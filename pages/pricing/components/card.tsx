...
export const CardLeft = (props: Price) => {
  return (
    <>
      <div className="w-72 bg-white rounded-l-lg mobile:rounded-lg drop-shadow-md">
...
export const CardCenter = (props: Price) => {
  return (
    <>
      <div className="w-96 mobile:w-72 z-10 bg-white border-blue-700 border-2 rounded-lg drop-shadow-md">
        <div className="h-40 mobile:h-28 border-b-2 border-gray-100 flex flex-col items-center justify-center">
          ...
          <div>
            <span className="text-3xl mobile:text-2xl mr-1 font-bold">{props.currency}</span>
            <span className="text-6xl mobile:text-4xl font-bold">{props.price}</span>
            <span className="text-gray-500">/{props.frequency}</span>
          </div>
        </div>
...
export const CardRight = (props: Price) => {
  return (
    <>
      <div className="w-72 bg-white rounded-r-lg mobile:rounded-lg drop-shadow-md">
        <div className="h-28 border-b-2 border-gray-100 flex flex-col items-center justify-center">
          <div className="text-2xl font-bold pb-2">{props.title}</div>
          <div>
            <span className="text-2xl mr-1 font-bold">{props.currency}</span>
